...
local function apply()
 ...
 local rainF=clamp(math.max(num(fusion.rain,0),num(rainDir.rain,0)),0,1);local puddleF=clamp(num(rainDir.puddle,num(fusion.puddle,0)),0,1);local surfaceF=clamp(math.max(num(fusionSurface,0),num(rainDir.surface,0)),0,1)
