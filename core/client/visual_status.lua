...
local function build()
 ...
 return {
  ...
  applyEnabled=a.enabled==true,budgetTier=b.tier or '?',budgetMultiplier=b.multiplier or 1.0,adapterMultiplier=ba.multiplier or 1.0,
  finish=fin.finish or 0.0,night=fin.night or 0.0,wetFactor=fin.wet or 0.0,stormFactor=fin.storm or 0.0,
  contextIntensity=ctx.intensity or 0.0,frameMs=b.frameMs or 0,lastState=a.lastStateKey or ''
 }
end
